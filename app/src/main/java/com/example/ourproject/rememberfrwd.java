...
public class rememberfrwd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopNumberRunnable();
                Intent intent = new Intent(rememberfrwd.this, MindTraining.class);
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if (inputNumbers.length != 5) {
                        Toast.makeText(rememberfrwd.this, "Please enter five numbers separated by spaces", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (isCorrect) {
                        Toast.makeText(rememberfrwd.this, "Great job! You got it right. There is nothing you can't do", Toast.LENGTH_SHORT).show();
                        score+=10;


                    }
                    else {
                        Toast.makeText(rememberfrwd.this, "Wrong answer. Keep trying you can make it!", Toast.LENGTH_SHORT).show();
